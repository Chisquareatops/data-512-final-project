...
The NHATS R8 Final Crosswalk between Instruments and Codebook, found on the NHATS website linked above, is 98 pages long. Not every measure has been considered for this project, and not all measures considered have been examined. However, a preliminary list of target variables has been identified as possible independent or dependent variables for the proposed analysis:
